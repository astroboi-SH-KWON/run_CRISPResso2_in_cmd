...
class run_CRISPResso2:
    ...
    def run_CRISPResso_fastq_r1(self, output_path, fastq_r1, guide_seq, amplicon_seq):
        os.system('CRISPResso --fastq_r1 {} -o {} --amplicon_seq {} --guide_seq {}'.
                  format(fastq_r1, output_path + guide_seq, amplicon_seq, guide_seq))
        return

    def run_CRISPResso_fastq_r1_r2_w_falsh(self, output_path, fastq_r1, fastq_r2, guide_seq, amplicon_seq):
